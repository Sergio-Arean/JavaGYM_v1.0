 ...
 * @author sergi
 */
public class DialogAgregarActividad extends javax.swing.JDialog {

    /**
     * Creates new form DialogRegistrarse
     */
    private Gimnasio gimnasio;
    public DialogAgregarActividad(java.awt.Frame parent, boolean modal,Gimnasio gimnasio) {
        super(parent, modal);
    ...
    /**
     * Permite cargar los distintos componentes con los valores necesarios,
     * asi como tambien establecer el formato de algunos de ellos.
     */
    private void CargarComponentes(){
        CargarComboBox();
        btnAgregar.putClientProperty( "JButton.buttonType", "roundRect" ); //botoncircular
        cbNombreActividad.setSelectedIndex(-1);
        cbNombreInstructor.setSelectedIndex(-1);
    ...
    /**
     * Permite obtener un ArrayList a partir del cual se cargaran los datos de la tabla que se 
     * muestra en pantalla
     * @return 
     */
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(48, 48, 48)
                        .addComponent(btnAgregar, javax.swing.GroupLayout.PREFERRED_SIZE, 428, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
if(c<'0' || c>'9') evt.consume();
    ...
    private void AgregarActividad() {
        ...
        try{
            gimnasio.agregar(nueva_actividad);
            Utilidades.MostrarMensajeInformativo("La actividad fue agregada exitosamente");
