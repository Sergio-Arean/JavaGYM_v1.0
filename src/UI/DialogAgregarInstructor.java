 ...
 * @author sergi
 */
public class DialogAgregarInstructor extends javax.swing.JDialog {

    /**
     * Creates new form DialogAgregarInstructor
     */
    private Gimnasio gimnasio;
    public DialogAgregarInstructor(java.awt.Frame parent, boolean modal,Gimnasio gimnasio) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnConfirmar.setText("Agregar Intructor");
...
//Solo numeros - parentesis y guion - telefonos
    ...
    private void AgregarInstructor() {
       ...
       EGenero genero = EGenero.valueOf(genero_formato_string);
        ...
        Instructor nuevo_instructor = new Instructor(tfNombre.getText(),tfDni.getText(),genero,tfTelefono.getText(),
        tfDomicilio.getText(),tfEmail.getText(),Eestado.ACTIVO,grupo_sanguineo,tfTelEmergencia.getText(),
        tfObraSocial.getText(),fecha_de_nacimiento,"",tfCuil.getText(),"");
        
        
        
        
        try{
            gimnasio.agregar(nuevo_instructor);
            Utilidades.MostrarMensajeInformativo("El Instructor " + nuevo_instructor.getNombre() +" fue agregado exitosamente");
            this.dispose();
