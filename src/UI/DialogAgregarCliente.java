...
public class DialogAgregarCliente extends javax.swing.JDialog {
    ...
    public DialogAgregarCliente(java.awt.Frame parent, boolean modal,Gimnasio gimnasio) {
        super(parent, modal);
        initComponents();
        CargarComponentes();
        ...
        //actividades_a_calcular = new TreeSet<>();
    ...
    private void initComponents() {
        ...
        btnConfirmar.setText("Ingresar Cliente");
                ...
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, backgroundLayout.createSequentialGroup()
                        ...
                        .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(backgroundLayout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(btnConfirmar, javax.swing.GroupLayout.PREFERRED_SIZE, 540, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addGap(37, 37, 37))
        );
...
if(c<'0' || c>'9') evt.consume();
    ...
    private void AgregarCliente() {
        ...
        Date fecha_date_inscripcion = dcFechaInscripcion.getDate();
        Instant instantt = fecha_date_inscripcion.toInstant();
        ZoneId zoneId1 = ZoneId.systemDefault();
        LocalDate fecha_de_inscripcion = instantt.atZone(zoneId1).toLocalDate();

        boolean alta_medica = checkAltaMedica.isSelected();
        boolean solicito_rutina = checkSolicitarRutina.isSelected();

        //Actividades
        TreeSet<Actividad> actividades = new TreeSet<>(actividades_a_calcular);

        Cliente cliente = new Cliente(tfNombre.getText(), tfDni.getText(), genero, tfTelefono.getText(),
                tfDomicilio.getText(), tfEmail.getText(), Eestado.ACTIVO, grupo_sanguineo, tfTelEmergencia.getText(),
                tfObraSocial.getText(), fecha_de_nacimiento, "", alta_medica, solicito_rutina, true, null,
                fecha_de_inscripcion, actividades);

        try {
            gimnasio.agregar(cliente);
            gimnasio.sumarInscripto(actividades);
            JOptionPane.showMessageDialog(null, "Cliente fue agregado exitosamente!", "", JOptionPane.PLAIN_MESSAGE, icono("/UI/imagenes/icon fuerza.png", 40, 40));
            this.dispose();

        } catch (ExistenteException e) {
            Utilidades.MostrarMensajeWarning("El DNI ingresado ya se encuentra presente en el sistema");
            System.out.println("cliente NO agregado. lista de clientes desdde el gym :\n");
    ...
    private void MostrarActividadEnLista(Actividad actividad) {
        ...
        if (model instanceof DefaultListModel) {
            ...
            Utilidades.MostrarMensajeInformativo("La actividad pude agregarse a la lista");
        }
