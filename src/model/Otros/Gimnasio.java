...
public class Gimnasio {
    ...
    public JSONObject actualizarJson() throws JSONException {
        /**
         * No incluye Responsable y Direccion
         */
    ...
    /**
     * Permite reconocer una actividad presente en el sistema(el metodo es
     * llamado desde la interfaz para ubicar una actividad)
     *
    ...
    public double CalcularPrecio(ArrayList<Actividad> actividades_a_calcular) {
        ...
        /*suponiendo que el precio base del gym es este*/
    ...
    public String VerActividadesInstructor(String dni_instructor) {
        ...
        try {
            ...
            if (!instructor.getComentario().equals("")) {
                rta += "\nComentarios:\n: " + instructor.getComentario();
            }
        } catch (JSONException e) {
            rta = e.getMessage();
        }
    ...
    public boolean ClienteEstadoInvalido(String dni_cliente) throws NoEncontradoException {
        boolean rta = false;
        Cliente cliente = LocalizarCliente(dni_cliente);
        if (cliente.EstadoInvalido()) {
            rta = true;
        }
        return rta;
